<template>
	<div class="sales-board">
      ...
      <div class="sales-board-form">
          ...
          <div class="sales-board-line">
              ...
              <div class="sales-board-line-right">
                  ...
                  @on-change="onParamChange('version', $event)"></v-mul-chooser>
              </div>
          </div>
          <div class="sales-board-line">
              <div class="sales-board-line-left">
      ...
      @on-close="toOrderList">购买成功</success-dialog>

      <fail-dialog 
      :is-show="isShowFailDialog" 
      @on-close="toOrderList">购买失败</fail-dialog>
...
import VChooser from '@/components/VChooser'
import VMulChooser from '@/components/VMulChooser'
...
import _ from 'lodash'
	export default {
		...
		methods: {
			...
			getPrice () {
				let versionArray = _.map(this.version, (item) => {
					return item.value
				})
				let totalParams = {
				...
				this.$http.post('/api/getPrice', totalParams).then((res) => {
			...
			confirmBuy () {
				...
				this.$http.post('/api/createOrder', totalParams).then((res) => {
